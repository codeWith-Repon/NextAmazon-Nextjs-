        ...
        {items.length === 0 ? (
          <Card className='col-span-4 rounded-none'>
            ...
            <CardContent>
              ...
              <Link
                href='/'
                className='font-bold italic relative hover:text-primary transition-all before:content-[""] before:absolute before:left-auto before:right-0 before:bottom-[-2px] before:h-[2px] before:w-0 before:bg-primary before:transition-all hover:before:w-full hover:before:left-0 hover:before:right-auto'
              >
                {APP_NAME}
              </Link>
            </CardContent>
